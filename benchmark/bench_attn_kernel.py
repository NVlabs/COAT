...
BENCH_CONFIGS = {
    "flash2-bf16": {
        "line_vals": "flash2-bf16",
        "line_names": "Flash2-BF16",
        "color": ("red", "-"),
    },
    "flash3-bf16": {
        "line_vals": "flash3-bf16",
        "line_names": "Flash3-BF16",
        "color": ("blue", "-"),
    },
    "flash3-fp8": {
        "line_vals": "flash3-fp8",
        "line_names": "Flash3-FP8",
        "color": ("purple", "-"),
    },
    "triton-bf16": {
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        '--methods', 
        nargs='+', 
        default=['flash2-bf16', 'flash3-bf16'],
