...
def _fp8_division_transpose_kernel(
    ...
    ONLY_TRANSPOSED_2D: tl.constexpr,
...
def fp8_division_transpose(x, QB, fp8type, s_y=None, only_transposed_2d=False):
    ...
    _fp8_division_transpose_kernel[grid](
        ...
        ONLY_TRANSPOSED_2D=only_transposed_2d,
    )
