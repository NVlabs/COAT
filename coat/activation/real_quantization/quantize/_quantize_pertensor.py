...
def fp8_quantize_pertensor(x, QB, fp8type, scale_dtype=torch.bfloat16, return_transposed_2d=False):
    ...
    if return_transposed_2d:
        y, s_y_max, qy_t = fp8_division_transpose(x, QB, fp8type, s_y_max)  # Stochastic Rounding happens here
    else:
        y, s_y_max = fp8_division(x, QB, fp8type, s_y_max)  # reuse the floating point output y1
