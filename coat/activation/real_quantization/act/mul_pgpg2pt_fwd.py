...
@triton.jit
def fp8_mul_pgpg2hp_forward_kernel(
    output_ptr,
    ...
    scale_input1 = tl.load(scale_input1_ptr, boundary_check=(0, 1))
    ...
    scale_input2 = tl.load(scale_input2_ptr, boundary_check=(0, 1))
...
def fp8_mul_pgpg2pt_forward(x1, s_x1, x2, s_x2, QB, return_transposed_2d=False):
    ...
    fp8_mul_pgpg2hp_forward_kernel[grid](
        y,
        s_y,
        x1,
        s_x1,
    ...
    if return_transposed_2d:
        ...
        qy, s_y_max = fp8_division(y, QB, x2.dtype, s_y_max)
