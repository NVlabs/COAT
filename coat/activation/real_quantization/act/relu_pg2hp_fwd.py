...
@triton.jit
def _fp8_relu_pg2hp_forward_kernel(
    output_ptr,
    input_ptr,
    ...
    # Dequantize and Relu calculation
...
def fp8_relu_pg2hp_forward(x, s_x, QB, transpose_output_2d=False):
    ...
    _fp8_relu_pg2hp_forward_kernel[grid](
        y,
        x,
        s_x,
        M,
